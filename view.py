...
# PPP: VIEW Module
#
# Graphic library: provided by pygtk
...
class Interfaccia():
    ...
    def __init__(self):
        ...
        self.icona_prezziario = gtk.ImageMenuItem(gtk.STOCK_CONVERT)
...
#        self.icona_menu_edit = gtk.MenuItem("Modifica")
        self.icona_menu_prezziario = gtk.MenuItem("Prezziario")

        # Set submenu
        self.icona_menu_file.set_submenu(self.menu_file)
        self.icona_menu_edit.set_submenu(self.menu_edit)
        self.icona_menu_prezziario.set_submenu(self.menu_prezziario)
        ...
        self.menu_prezziario.append(self.icona_prezziario)
        ...
        # Set treestore
        self.lista = []
        self.archivio = gtk.TreeStore(int, 
                                      str, 
                                      str, 
                                      str, 
                                      str, 
...
#            self.archivio.append(None, [self.lista[i]])
        ...
        self.colonna_progr.add_attribute(self.cella_progressivo, 
                                       "cell-background", 7)
        ...
        self.colonna_cod.add_attribute(self.cella_codice, 
                                       "cell-background", 7)
        ...
        self.colonna_desc.add_attribute(self.cella_descrizione, 
                                       "cell-background", 7)
        ...
        self.colonna_um.add_attribute(self.cella_unitamisura, 
                                       "cell-background", 8)
        ...
        self.colonna_pu.add_attribute(self.cella_prezzo, 
                                       "cell-background", 9)
...
#        self.icona_prezziario.connect('activate', self.converti_prezziarioPAT)

    def main(self):
        gtk.main()

    def finestra_apri(self):
        messaggio = gtk.FileChooserDialog(action = gtk.FILE_CHOOSER_ACTION_OPEN,
                                          buttons = (gtk.STOCK_CANCEL,
                                                     gtk.RESPONSE_CANCEL,
                                                     gtk.STOCK_OPEN,
                                                     gtk.RESPONSE_OK))
        risposta = messaggio.run()
        if risposta == gtk.RESPONSE_OK:
            filename = messaggio.get_filename()
